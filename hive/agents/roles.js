...
module.exports = [
  {
    id: 'project-manager', name: 'Project Manager', lead: '@claude', claudeModel: 'inherit', agyModel: 'claude-opus-4-6-thinking', kind: 'review', color: 'pink',
...
Output: a numbered plan, the tickets created (ids), and the questions that only the user can answer.`,
  ...
  {
    id: 'frontend-engineer', name: 'Frontend Engineer', lead: '@agy-cli', claudeModel: 'inherit', agyModel: 'gemini-3.1-pro-high', kind: 'code', color: 'blue',
...
Output: the diff, before and after screenshots, and the checks you ran.`,
  ...
  {
    id: 'backend-engineer', name: 'Backend Engineer', lead: '@claude', claudeModel: 'inherit', agyModel: 'claude-opus-4-6-thinking', kind: 'code', color: 'blue',
...
Output: the diff, the check and its output, and any migration or config the head must apply.`,
  ...
  {
    id: 'ui-ux-designer', name: 'UI/UX Designer', lead: '@agy-cli', claudeModel: 'inherit', agyModel: 'gemini-3.1-pro-high', kind: 'design', color: 'purple',
...
Output: the design (code or canvas), the reasoning in short lines, and what you need the user to decide.`,
  ...
  {
    id: 'brand-designer', name: 'Brand and Visual Designer', lead: '@agy-cli', claudeModel: 'inherit', agyModel: 'gemini-3.1-pro-high', kind: 'design', color: 'purple',
...
Output: the files, a note of every brand rule applied, and anything that needs an asset from the user.`,
  ...
  {
    id: 'seo-specialist', name: 'SEO Specialist', lead: '@claude', claudeModel: 'inherit', agyModel: 'claude-opus-4-6-thinking', kind: 'research', color: 'green',
...
Output: findings ranked by impact, the exact fix for each, and the risk of each fix.`,
  ...
  {
    id: 'aeo-expert', name: 'AEO and GEO Expert', lead: '@agy-cli', claudeModel: 'inherit', agyModel: 'gemini-3.1-pro-high', kind: 'research', color: 'green',
...
Output: a table of questions, current citations, and the specific page changes that would earn the citation.`,
  ...
  {
    id: 'keyword-researcher', name: 'Keyword Researcher and Planner', lead: '@agy-cli', claudeModel: 'inherit', agyModel: 'gemini-3.1-pro-high', kind: 'research', color: 'green',
...
Output: a keyword matrix (keyword, language, intent, target page, match type suggestion) and a negatives list.`,
  ...
  {
    id: 'content-writer', name: 'Multilingual Content Writer', lead: '@agy-cli', claudeModel: 'inherit', agyModel: 'gemini-3.1-pro-high', kind: 'content', color: 'cyan',
...
Output: the copy per language, character counts, and every placeholder listed.`,
  ...
  {
    id: 'localization-reviewer', name: 'Localization Reviewer', lead: '@agy-cli', claudeModel: 'inherit', agyModel: 'gemini-3.1-pro-high', kind: 'review', color: 'cyan',
...
Output: a table of line, problem, suggested fix, and confidence. Say plainly that a human native speaker should confirm.`,
  ...
  {
    id: 'digital-marketer', name: 'Digital Marketer', lead: '@agy-cli', claudeModel: 'inherit', agyModel: 'gemini-3.1-pro-high', kind: 'research', color: 'orange',
...
Output: a plan with steps, owners, measurement, and what must be true before money is spent.`,
  ...
  {
    id: 'google-ads-expert', name: 'Google Ads Expert', lead: '@claude', claudeModel: 'inherit', agyModel: 'claude-opus-4-6-thinking', kind: 'research', color: 'orange',
...
Output: campaign structure, keywords and negatives, ad copy drafts per language, and the tracking checklist.`,
  ...
  {
    id: 'meta-ads-analyst', name: 'Meta Ads Analyst', lead: '@agy-cli', claudeModel: 'inherit', agyModel: 'gemini-3.1-pro-high', kind: 'research', color: 'orange',
...
Output: a short table of what to keep, fix or stop, and the one change with the biggest expected effect.`,
  ...
  {
    id: 'google-maps-expert', name: 'Google Maps and Business Profile Expert', lead: '@claude', claudeModel: 'inherit', agyModel: 'claude-opus-4-6-thinking', kind: 'research', color: 'green',
...
Output: a prioritised list of profile changes, the exact text for each, and what needs the owner.`,
  ...
  {
    id: 'data-analyst', name: 'Data Analyst', lead: '@agy-cli', claudeModel: 'inherit', agyModel: 'gemini-3.1-pro-high', kind: 'research', color: 'yellow',
...
Output: the answer in two lines, the evidence table, and the caveats.`,
  ...
  {
    id: 'performance-engineer', name: 'Performance Engineer', lead: '@claude', claudeModel: 'inherit', agyModel: 'claude-opus-4-6-thinking', kind: 'code', color: 'blue',
...
Output: before and after numbers per page, each change, and its effect.`,
  ...
  {
    id: 'accessibility-auditor', name: 'Accessibility Auditor', lead: '@agy-cli', claudeModel: 'inherit', agyModel: 'gemini-3.1-pro-high', kind: 'review', color: 'red',
...
Output: findings grouped by selector across pages, highest impact first.`,
  ...
  {
    id: 'qa-tester', name: 'QA Tester', lead: '@agy-cli', claudeModel: 'inherit', agyModel: 'gemini-3.1-pro-high', kind: 'review', color: 'red',
...
Output: pass or fail per journey, and bug reports for each failure.`,
  ...
  {
    id: 'compliance-reviewer', name: 'Medical and Ad Compliance Reviewer', lead: '@claude', claudeModel: 'inherit', agyModel: 'claude-opus-4-6-thinking', kind: 'review', color: 'red',
...
Output: pass, or a list of each problem with the exact replacement text.`,
  ...
  {
    id: 'devops-deployer', name: 'DevOps and Deploy', lead: '@claude', claudeModel: 'inherit', agyModel: 'claude-opus-4-6-thinking', kind: 'code', color: 'blue',
...
Output: what changed, where, the backup path, the verification, and the rollback command.`,
  ...
  {
    id: 'researcher', name: 'Researcher', lead: '@agy-cli', claudeModel: 'inherit', agyModel: 'gemini-3.1-pro-high', kind: 'research', color: 'yellow',
...
Output: a two-line answer, a sourced findings list, and open questions.`,
  ...
  {
    id: 'video-editor', name: 'Video Editor', lead: '@agy-cli', claudeModel: 'inherit', agyModel: 'gemini-3.1-pro-high', kind: 'bulk', color: 'purple',
...
Output: the files, their specs, and the ffmpeg commands used.`,
  ...
  {
    id: 'image-generator', name: 'Image Generator', lead: '@agy-cli', claudeModel: 'inherit', agyModel: 'gemini-3.1-pro-high', kind: 'design', color: 'purple',
