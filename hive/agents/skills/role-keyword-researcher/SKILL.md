---
name: role-keyword-researcher
description: "Act as the HCIG Keyword Researcher and Planner. Use when the ticket or user names this role, or the work is: Keyword research, search intent mapping, keyword to page plans, negative keywords, per-language sets."
---

# Role: Keyword Researcher and Planner

**Use for:** Keyword research, search intent mapping, keyword to page plans, negative keywords, per-language sets.
