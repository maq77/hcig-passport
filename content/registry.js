    ...
    projects: [
      ...
      },
      {
        ...
        stages: [
          ...
          {
            name: 'Preview',
            note: 'The new homepage, and the earlier one on their layout for comparison.',
            items: [
              { slug: 'new-home', name: 'New homepage', kind: 'link', href: 'https://hcig-passport.vercel.app/247clinic/new', status: 'review', note: 'Our design on their brand book. Her words only' },
              { slug: 'home', name: 'Homepage on their layout', kind: 'link', href: 'https://hcig-passport.vercel.app/247clinic/website-preview', status: 'review', note: 'The earlier approach, kept for comparison' },
            ],
          },
        ],
      },
