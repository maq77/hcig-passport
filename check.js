...
/* Projects marked hidden keep their URLs but must not be named or linked
   anywhere else on the site, including in a meta description. A hardcoded
   description naming two held-back programmes is exactly the leak this
   catches. */
...
for (const file of htmlFiles) {
  ...
  // a held-back project must not surface on any page but its own
  const here = rel(file);
